      ...
      <section className="flex flex-col-reverse md:flex-row items-center gap-12 mb-24">
        ...
        <div className="md:w-2/3">
          ...
          <div className="flex items-center gap-4">
            <a href="https://github.com/devrugu" target="_blank" rel="noopener noreferrer" className="text-primary hover:text-accent transition-colors">
            ...
            <a href="https://tr.linkedin.com/in/kazuhira" target="_blank" rel="noopener noreferrer" className="text-primary hover:text-accent transition-colors">
